<div class="elementContent">
    ...
    <div class="contentMetaDesc">
        <input type="text" class="datetimepicker" name="<?php echo $field_id ?>" id="<?php echo $field_id ?>" value="<?php echo $value_field ?>"
          data-date_format="<?php echo $opt['date_format'] ?>" data-time_format="<?php echo $opt['time_format'] ?>" data-time_zone="<?php echo $opt['time_zone'] ?>" 
