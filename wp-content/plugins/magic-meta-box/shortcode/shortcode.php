...
function add_google_map( $atts ) {
	$atts = shortcode_atts( array('lat' => 27.0881198382541,'lng' => 29.756923124999958, 'zoom' => 4, 'width' => '100%', 'height' => '400px', 'key' => '' ), $atts, 'google_map' );
	extract($atts);
	...
	wp_register_script('googleMapFrontEndJS','https://maps.googleapis.com/maps/api/js?libraries=places&key='. $key);
