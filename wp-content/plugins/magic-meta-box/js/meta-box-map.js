jQuery(document).ready(function($){
  ...
  google.maps.event.addListener(map, 'bounds_changed', function() {
	...
	function set_new_position_marker(event) {
		...
		$('.mapMetaboxContainer .markerPositionLat').val(marker.position.lat());
	    $('.mapMetaboxContainer .markerPositionLng').val(marker.position.lng());
	...
	$('.shortcodePreviewButton').click(function(){
		var shortcodeString = '[gs_google_map lat="' + $('.mapMetaboxContainer .markerPositionLat').val() + '" lng="' + $('.mapMetaboxContainer .markerPositionLng').val() + '" zoom="' + $('.mapMetaboxContainer .mapZoom').val() + '" width="100%" height="400px" key="your key"]';
